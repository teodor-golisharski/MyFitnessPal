...
const std::string INVALID_WEIGHT = "Invalid weight. Please enter a positive number: ";
const std::string INVALID_HEIGHT = "Invalid height. Please enter a positive number: ";
